...
export const localeText = {
  zh: {
    datasets: "数据集", training: "训练", models: "模型", agent: "智能体", samSettings: "SAM 设置", languageSettings: "语言设置", logs: "日志",
    localMode: "本地模式", workspace: "我的工作区", community: "社区版", settingsGroup: "设置", workspaceGroup: "工作区",
  },
  en: {
    datasets: "Datasets", training: "Training", models: "Models", agent: "Agent", samSettings: "SAM settings", languageSettings: "Language", logs: "Logs",
