...
| `fastapi` | `0.115.6` | OSI Approved :: MIT License |
| `filelock` | `3.32.2` | OSI Approved :: MIT License |
| `flatbuffers` | `25.12.19` | OSI Approved :: Apache Software License |
| `fonttools` | `4.63.0` | MIT |
| `fsspec` | `2026.7.0` | UNKNOWN |
| `h11` | `0.16.0` | OSI Approved :: MIT License |
| `httpcore` | `1.0.9` | OSI Approved :: BSD License |
| `httptools` | `0.8.0` | UNKNOWN |
| `httpx` | `0.28.1` | OSI Approved :: BSD License |
| `idna` | `3.18` | UNKNOWN |
| `iniconfig` | `2.3.0` | UNKNOWN |
| `jinja2` | `3.1.6` | OSI Approved :: BSD License |
| `kiwisolver` | `1.5.0` | OSI Approved :: BSD License |
| `mako` | `1.4.1` | UNKNOWN |
...
| `onnxscript` | `0.7.0` | OSI Approved :: MIT License |
| `opencv-python` | `4.11.0.86` | OSI Approved :: Apache Software License |
...
| `pytest` | `8.3.4` | OSI Approved :: MIT License |
| `python-dateutil` | `2.9.0.post0` | OSI Approved :: BSD License; OSI Approved :: Apache Software License |
| `python-dotenv` | `1.2.2` | BSD (declared text) |
| `python-multipart` | `0.0.19` | OSI Approved :: Apache Software License |
| `pyyaml` | `6.0.2` | OSI Approved :: MIT License |
| `requests` | `2.34.2` | OSI Approved :: Apache Software License |
| `scipy` | `1.17.1` | OSI Approved :: BSD License |
| `seaborn` | `0.13.2` | OSI Approved :: BSD License |
| `setuptools` | `83.0.0` | UNKNOWN |
| `six` | `1.17.0` | OSI Approved :: MIT License |
| `sqlalchemy` | `2.0.36` | OSI Approved :: MIT License |
| `starlette` | `0.41.3` | OSI Approved :: BSD License |
| `sympy` | `1.14.0` | OSI Approved :: BSD License |
| `torch` | `2.13.0` | UNKNOWN |
...
| `uvloop` | `0.22.1` | OSI Approved :: Apache Software License; OSI Approved :: MIT License |
...
| `cssstyle` | `4.6.0` | MIT |
| `cssstyle/node_modules/rrweb-cssom` | `0.8.0` | MIT |
| `csstype` | `3.2.3` | MIT |
| `data-urls` | `5.0.0` | MIT |
| `debug` | `4.4.3` | MIT |
